            ...
            <div className="container mx-auto py-10">
                ...
                <div className="flex lg:flex-row flex-col items-center">
                    ...
                    <div className="flex flex-col justify-center items-center w-full xl:h-96 xl:w-4/12 mb-5">
                        ...
                        <p className="text-xs w-3/4 text-center text-white">Монгол блокчэйн төслүүдийг дэлхийн тавцанд гаргах DEX байх болно. Гадаад орны хөрөнгө оруулагчид Монгол блокчэйн төслүүдэд хөрөнгө оруулах хамгийн хурдан, хялбар зам байх болно.</p>
                    </div>
                    <div className="flex flex-col justify-center items-center w-full xl:h-96 xl:w-4/12">
                        ...
                        <p className="text-xs w-3/4 text-center text-white">АрдМааний эзэмшигчид бүх шинэчлэлт, сайжруулалтанд саналаа өгч оролцох боломжтой.</p>
                    </div>
                </div>
            </div>
        </div>
