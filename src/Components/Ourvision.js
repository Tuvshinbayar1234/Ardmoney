        ...
        <div id="Our" className="w-full h-full" style={{backgroundColor: '#1F1E29'}}>
            <div className="container py-32 mx-auto">
                ...
                <div className="flex flex-col items-center justify-center lg:flex-row">
                  ...
                  <div className="flex flex-col items-center justify-center w-full mt-5 md:mt-0 xl:h-96 xl:w-4/12">
                        <img src={Water} />
                  ...
                  <div className="flex flex-col items-center justify-center w-full mt-2 mt-5 md:m5-0 xl:h-96 xl:w-4/12">
                        <img src={Exchange} />
                        <h1 className="flex items-center justify-center mb-3 text-lg font-semibold text-center text-white xl:text-lg">
                    ...
                    <div className="relative flex flex-col items-center justify-center w-full mt-5 md:m5-0 xl:h-96 xl:w-4/12 md:-top-3">
                        <img src={Denluu} />
                        <h1 className="flex items-center justify-center mb-3 text-lg font-semibold text-center text-white xl:text-lg">
