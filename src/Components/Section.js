    ...
    return(
        <div className=" bg-gray-600" style={{backgroundImage: `url(${Coin})`, backgroundSize: '100% 100%'}}>
            <div className="container mx-auto py-72 flex flex-col">
                ...
                <p className="font-medium mt-10 w-1/3 text-xl text-white lg:block">
                    Таны төвлөрсөн бус, бие даасан санхүүгийн оролцооны гарц    
                </p>
                <div className=" w-60 h-11 bg-red-50 text-center flex justify-center items-center rounded-lg mt-10 lg:block">
